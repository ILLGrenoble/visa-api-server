...
import eu.ill.visa.cloud.domain.CloudResourceAllocation;
...
public interface PlacementEndpoint {
    ...
    List<CloudResourceAllocation> resourceAllocations(final String resourceProviderId) throws CloudException, CloudUnavailableException;
}
