...
public class InstanceExtensionRenderer implements NotificationRenderer {
    ...
    public String render() throws NotificationRendererException {
        try {
            ...
            final PebbleTemplate compiledTemplate = engine.getTemplate(emailTemplatesDirectory + "instance-extension.twig");
