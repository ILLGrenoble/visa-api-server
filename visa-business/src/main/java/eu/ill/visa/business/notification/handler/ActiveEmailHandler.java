...
@LookupIfProperty(name = "business.mailer.enabled", stringValue = "true")
@Singleton
public class ActiveEmailHandler implements EmailHandler {
    ...
    public void sendInstanceCreatedNotification(final Instance instance) {
        if (devEmailAddress != null && !devEmailAddress.isEmpty()) {
            try {
                final User owner = this.instanceMemberService.getOwnerByInstanceId(instance.getId());
                if (owner != null) {
