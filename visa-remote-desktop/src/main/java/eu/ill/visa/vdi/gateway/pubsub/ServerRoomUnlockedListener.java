...
import static eu.ill.visa.vdi.domain.events.Event.ROOM_UNLOCKED_EVENT;

public class ServerRoomUnlockedListener implements PubSubListener<DispatchMessage> {

    private final DesktopConnectionService desktopConnectionService;
    private final SocketIOServer server;

    public ServerRoomUnlockedListener(final DesktopConnectionService desktopConnectionService,
    ...
    public void onMessage(final DispatchMessage message) {
        ...
        if (type != null && type.equals(ROOM_UNLOCKED_EVENT)) {
